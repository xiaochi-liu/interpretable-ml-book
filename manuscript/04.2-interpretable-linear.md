...
<img src="images/linear-effects-1.png" alt="The feature effect plot shows the distribution of the effects (= feature value times feature weight) over the dataset for each feature." width="80%" />
<p class="caption">
...
<img src="images/linear-effects-single-1.png" alt="The effect for one instance shows the effect distribution while highlighting the effects of the instance of interest." width="80%" />
<p class="caption">
