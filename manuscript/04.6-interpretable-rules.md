...
|else if {Hormonal.Contraceptives..years.=[10,20)} (rule[89]) then positive probability = 0.30000000 |
|else  (default rule)  then positive probability = 0.04780876                                        |
...
|Num.of.pregnancies=[ 0.00, 3.67),STDs..Number.of.diagnosis=[0,1) |
|Smokes=1                                                         |
|First.sexual.intercourse=[10.0,17.3)                             |
|Smokes=1,STDs..Number.of.diagnosis=[0,1)                         |
|STDs..number.=[1.33,2.67)                                        |
|Num.of.pregnancies=[ 3.67, 7.33)                                 |
|Num.of.pregnancies=[ 3.67, 7.33),IUD..years.=[ 0.00, 6.33)       |
|Age=[13.0,36.7),STDs..Number.of.diagnosis=[1,2)                  |
...
|rules                                                                                                        |
|:------------------------------------------------------------------------------------------------------------|
|If      {season=SPRING,yr=2012,days_since_2011=[243,487)} (rule[344]) then positive probability = 0.42682927 |
|else if {season=SPRING} (rule[351]) then positive probability = 0.00970874                                   |
|else if {yr=2012} (rule[861]) then positive probability = 0.94584838                                         |
|else if {weathersit=GOOD,temp=[19.93,32.50]} (rule[519]) then positive probability = 0.88297872              |
|else  (default rule)  then positive probability = 0.41081081                                                 |
