...
<img src="images/pdp-bike-1.png" alt="Partial dependence plot of rental bike count and different weather measurements (Temperature, Humidity, Windspeed). The biggest differences can be seen in different temperatures: With rising temperatures, on average the bike rentals rise, until 20C degrees, where it stays the same also for hotter temperatures and drops a bit again towards 30C degrees." width="80%" />
<p class="caption">
...
only more data could answer this question.
</p>
