...
![The importance for each of the features in predicting cervical cancer with an xgboost model.  The importance is the factor by which the error is increased compared to the original model error.](images/importance-cervical-1.png)


The feature with the highest importance was  associated with an error increase of 1.26 after permutation.
