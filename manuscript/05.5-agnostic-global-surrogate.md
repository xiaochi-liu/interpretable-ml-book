...
The surrogate model has an R squared (variance explained) of 0.19 which means it doesn't approximate the  random forest well and we should not over-interpret the tree, when drawing conclusions about the complex model.
