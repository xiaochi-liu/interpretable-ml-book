...
The plot clearly shows that the SVM has learned to rely on feature X13 for its predictions, but according to the feature importance based on the test data (0.97), it's not important.
