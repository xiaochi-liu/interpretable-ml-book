...
The mean absolute error (mae)for the training data is 0.29 and for the test data 0.82, which is also the error of the best possible model that always predicts the mean outcome of 0 (mae of  0.78).
...
![](images/importance-cervical-1.png)
