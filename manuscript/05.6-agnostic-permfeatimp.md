...
The plot clearly shows that the SVM has learned to rely on feature X42 for its predictions, but according to the feature importance based on the test data (0.99), it is not important.
Based on the training data, the importance is 1.17, reflecting that the model has learned to use this feature.
...
![The importance of each of the features for predicting cervical cancer with a random forest. The most important feature was Hormonal.Contraceptives..years.. Permuting Hormonal.Contraceptives..years. resulted in an increase in 1-AUC by a factor of 5.12](images/importance-cervical-1.png)


The feature with the highest importance was Hormonal.Contraceptives..years. associated with an error increase of 5.12 after permutation.
