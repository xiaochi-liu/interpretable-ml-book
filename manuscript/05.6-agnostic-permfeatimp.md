...
![PDP of feature X20, which is the most important feature according to the feature importance based on the training data. The plot shows how the SVM depends on this feature to make predictions](images/garbage-svm-pdp-1.png)
...
![The importance of each of the features for predicting cervical cancer with a random forest. The most important feature was Age. Permuting Age resulted in an increase in 1-AUC by a factor of 5.76](images/importance-cervical-1.png)
