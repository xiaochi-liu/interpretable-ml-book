...
|:--------------------------------|----------:|
|Age                              |  0.0133333|
|First.sexual.intercourse         |  0.0533333|
|Hormonal.Contraceptives          |  0.0150000|
|Hormonal.Contraceptives..years.  |  0.0436667|
|IUD                              |  0.0006667|
|IUD..years.                      | -0.0006667|
|Num.of.pregnancies               |  0.0283333|
|Number.of.sexual.partners        |  0.0286667|
|STDs                             |  0.0436667|
|STDs..Number.of.diagnosis        |  0.1236667|
|STDs..Time.since.first.diagnosis | -0.0003333|
|STDs..Time.since.last.diagnosis  |  0.0016667|
|STDs..number.                    |  0.0960000|
|Smokes                           | -0.0010000|
...
![Feature value contributions for instance 285. With a predicted 2417 rented bikes, this day is -2095 below the average prediction of 4511. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2095).](images/shapley-bike-plot-1.png)


|feature         |      phi|
|:---------------|--------:|
|days_since_2011 |  -680.12|
|holiday         |     0.11|
|hum             | -1114.01|
|mnth            |    11.27|
|season          |     4.91|
