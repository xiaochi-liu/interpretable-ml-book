...
![The predicted price for our apartment is 300.000€. It's a 50 square meter apartment on the second floor. There is a park nearby and cats are forbidden. Our goal is to explain how each of these features values contributed towards the predicted price of 300k€.](./images/shapley-instance.jpg)
...
![Feature value contributions for woman 326 in the cervical cancer dataset. With a prediction of 0.70, this woman's cancer probability is 0.67 above the average prediction of 0.03. The feature value that increased the probability the most is the number of diagnosed STDs. The feature contributions sum up to the difference of actual and average prediction (0.67).](images/shapley-cervical-plot-1.png)

|feature                          |        phi|
|:--------------------------------|----------:|
|Age                              |  0.0406667|
|First.sexual.intercourse         |  0.0796667|
|Hormonal.Contraceptives          |  0.0106667|
|Hormonal.Contraceptives..years.  |  0.0563333|
|IUD                              | -0.0006667|
|IUD..years.                      | -0.0023333|
|Num.of.pregnancies               |  0.0693333|
|Number.of.sexual.partners        |  0.0836667|
|STDs                             |  0.1796667|
|STDs..Number.of.diagnosis        |  0.0890000|
|STDs..Time.since.first.diagnosis |  0.0070000|
|STDs..Time.since.last.diagnosis  | -0.0003333|
|STDs..number.                    |  0.0503333|
|Smokes                           | -0.0020000|
|Smokes..years.                   |  0.0020000|
...
![Feature value contributions for instance 285. With a predicted 2499 rented bikes, this day is -2011 below the average prediction of 4510. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2011).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -607.73|
|holiday         |    4.22|
|hum             | -869.33|
|mnth            |   45.80|
|season          |   -7.86|
