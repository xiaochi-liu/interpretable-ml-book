...
![Feature value contributions for woman 326 in the cervical cancer dataset. With a prediction of 0.57, this woman's cancer probability is 0.54 above the average prediction of 0.03. The feature value that increased the probability the most is the number of diagnosed STDs. The feature contributions sum up to the difference of actual and average prediction (0.54).](images/shapley-cervical-plot-1.png)

|feature                          |        phi|
|:--------------------------------|----------:|
|Age                              |  0.0446667|
|First.sexual.intercourse         |  0.0576667|
|Hormonal.Contraceptives          |  0.0120000|
|Hormonal.Contraceptives..years.  |  0.0246667|
|IUD                              |  0.0003333|
|IUD..years.                      |  0.0000000|
|Num.of.pregnancies               |  0.0296667|
|Number.of.sexual.partners        |  0.0763333|
|STDs                             |  0.0766667|
|STDs..Number.of.diagnosis        |  0.1416667|
|STDs..Time.since.first.diagnosis |  0.0020000|
|STDs..Time.since.last.diagnosis  |  0.0003333|
|STDs..number.                    |  0.0436667|
|Smokes                           | -0.0010000|
|Smokes..years.                   | -0.0003333|
...
![Feature value contributions for instance 285. With a predicted 2548 rented bikes, this day is -1964 below the average prediction of 4511. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-1964).](images/shapley-bike-plot-1.png)


|feature         |      phi|
|:---------------|--------:|
|days_since_2011 |  -837.61|
|holiday         |     0.67|
|hum             | -1009.58|
|mnth            |    38.73|
|season          |    22.95|
