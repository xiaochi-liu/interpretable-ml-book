...
|:--------------------------------|----------:|
|Age                              |  0.0293333|
|First.sexual.intercourse         |  0.0646667|
|Hormonal.Contraceptives          |  0.0110000|
|Hormonal.Contraceptives..years.  |  0.0476667|
|IUD                              |  0.0016667|
|IUD..years.                      |  0.0013333|
|Num.of.pregnancies               |  0.0120000|
|Number.of.sexual.partners        |  0.0533333|
|STDs                             |  0.1080000|
|STDs..Number.of.diagnosis        |  0.0656667|
|STDs..Time.since.first.diagnosis |  0.0070000|
|STDs..Time.since.last.diagnosis  |  0.0033333|
...
![Feature value contributions for instance 285. With a predicted 2521 rented bikes, this day is -1985 below the average prediction of 4506. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-1985).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -318.64|
|holiday         |    0.00|
|hum             | -971.22|
|mnth            |   88.09|
|season          |   47.20|
