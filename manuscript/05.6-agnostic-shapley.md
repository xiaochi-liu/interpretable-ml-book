...
|:--------------------------------|----------:|
|Age                              |  0.0016667|
|First.sexual.intercourse         |  0.0266667|
|Hormonal.Contraceptives          |  0.0123333|
|Hormonal.Contraceptives..years.  |  0.0100000|
|IUD                              | -0.0006667|
|IUD..years.                      |  0.0010000|
|Num.of.pregnancies               |  0.0353333|
|Number.of.sexual.partners        |  0.0786667|
|STDs                             |  0.1223333|
|STDs..Number.of.diagnosis        |  0.1163333|
|STDs..Time.since.first.diagnosis |  0.0010000|
|STDs..Time.since.last.diagnosis  |  0.0000000|
|STDs..number.                    |  0.0320000|
|Smokes                           |  0.0000000|
|Smokes..years.                   |  0.0006667|
...
![Feature value contributions for instance 285. With a predicted 2258 rented bikes, this day is -2249 below the average prediction of 4507. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2249).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -627.85|
|holiday         |    0.00|
|hum             | -946.34|
|mnth            |  -18.87|
|season          |   64.41|
