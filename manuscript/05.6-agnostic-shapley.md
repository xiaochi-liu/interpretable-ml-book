...
![Feature value contributions for woman 326 in the cervical cancer dataset. With a prediction of 0.47, this woman's cancer probability is 0.44 above the average prediction of 0.03. The feature value that increased the probability the most is the number of diagnosed STDs. The feature contributions sum up to the difference of actual and average prediction (0.44).](images/shapley-cervical-plot-1.png)

|feature                          |        phi|
|:--------------------------------|----------:|
|Age                              |  0.0443333|
|First.sexual.intercourse         |  0.0696667|
|Hormonal.Contraceptives          |  0.0143333|
|Hormonal.Contraceptives..years.  |  0.0260000|
|IUD                              | -0.0006667|
|IUD..years.                      | -0.0033333|
|Num.of.pregnancies               |  0.0253333|
|Number.of.sexual.partners        |  0.0503333|
|STDs                             |  0.0970000|
|STDs..Number.of.diagnosis        |  0.0480000|
|STDs..Time.since.first.diagnosis |  0.0023333|
|STDs..Time.since.last.diagnosis  |  0.0070000|
|STDs..number.                    |  0.0440000|
|Smokes                           | -0.0006667|
...
![Feature value contributions for instance 285. With a predicted 2633 rented bikes, this day is -1875 below the average prediction of 4508. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-1875).](images/shapley-bike-plot-1.png)


|feature         |      phi|
|:---------------|--------:|
|days_since_2011 |  -661.50|
|holiday         |     1.80|
|hum             | -1141.60|
|mnth            |   -20.31|
|season          |    41.33|
