...
![Feature value contributions for woman 326 in the cervical cancer dataset. With a prediction of 0.50, this woman's cancer probability is 0.47 above the average prediction of 0.03. The feature value that increased the probability the most is the number of diagnosed STDs. The feature contributions sum up to the difference of actual and average prediction (0.47).](images/shapley-cervical-plot-1.png)

|feature                          |        phi|
|:--------------------------------|----------:|
|Age                              |  0.0423333|
|First.sexual.intercourse         |  0.0360000|
|Hormonal.Contraceptives          |  0.0113333|
|Hormonal.Contraceptives..years.  |  0.0306667|
|IUD                              |  0.0023333|
|IUD..years.                      |  0.0006667|
|Num.of.pregnancies               |  0.0173333|
|Number.of.sexual.partners        |  0.0713333|
|STDs                             |  0.0406667|
|STDs..Number.of.diagnosis        |  0.0953333|
|STDs..Time.since.first.diagnosis |  0.0090000|
|STDs..Time.since.last.diagnosis  | -0.0040000|
|STDs..number.                    |  0.1103333|
|Smokes                           | -0.0040000|
|Smokes..years.                   | -0.0013333|
...
![Feature value contributions for instance 285. With a predicted 2449 rented bikes, this day is -2063 below the average prediction of 4512. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2063).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -448.04|
|holiday         |    0.00|
|hum             | -999.14|
|mnth            |   13.29|
|season          |   42.15|
