...
|:--------------------------------|----------:|
|Age                              |  0.0446667|
|First.sexual.intercourse         |  0.0456667|
|Hormonal.Contraceptives          |  0.0026667|
|Hormonal.Contraceptives..years.  |  0.0366667|
|IUD                              | -0.0020000|
|IUD..years.                      |  0.0046667|
|Num.of.pregnancies               |  0.0136667|
|Number.of.sexual.partners        |  0.0666667|
|STDs                             |  0.0653333|
|STDs..Number.of.diagnosis        |  0.0533333|
|STDs..Time.since.first.diagnosis |  0.0046667|
|STDs..Time.since.last.diagnosis  | -0.0013333|
|STDs..number.                    |  0.0680000|
|Smokes                           | -0.0026667|
|Smokes..years.                   | -0.0023333|
...
![Feature value contributions for instance 285. With a predicted 2354 rented bikes, this day is -2160 below the average prediction of 4515. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2160).](images/shapley-bike-plot-1.png)


|feature         |      phi|
|:---------------|--------:|
|days_since_2011 |  -387.46|
|holiday         |     0.49|
|hum             | -1014.98|
|mnth            |  -115.38|
|season          |    42.02|
