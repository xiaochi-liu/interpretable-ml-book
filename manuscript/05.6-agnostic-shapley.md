...
![Feature value contributions for instance 285. With a predicted 2406 rented bikes, this day is -2100 below the average prediction of 4507. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2100).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -704.18|
|holiday         |    0.31|
|hum             | -982.84|
|mnth            |  -12.53|
|season          |   13.64|
