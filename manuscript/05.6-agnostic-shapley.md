...
![Feature value contributions for instance 285. With a predicted 2507 rented bikes, this day is -2001 below the average prediction of 4508. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2001).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -535.93|
|holiday         |   -4.05|
|hum             | -869.01|
|mnth            |   34.84|
|season          |   23.87|
