...
|:--------------------------------|----------:|
|Age                              |  0.0480000|
|First.sexual.intercourse         |  0.0626667|
|Hormonal.Contraceptives          | -0.0023333|
|Hormonal.Contraceptives..years.  |  0.0433333|
|IUD                              |  0.0013333|
|IUD..years.                      | -0.0020000|
|Num.of.pregnancies               |  0.0496667|
|Number.of.sexual.partners        |  0.0490000|
|STDs                             |  0.0910000|
|STDs..Number.of.diagnosis        |  0.0690000|
|STDs..Time.since.first.diagnosis |  0.0030000|
|STDs..Time.since.last.diagnosis  |  0.0030000|
|STDs..number.                    |  0.1013333|
|Smokes                           |  0.0030000|
|Smokes..years.                   |  0.0010000|
...
![Feature value contributions for instance 285. With a predicted 2415 rented bikes, this day is -2097 below the average prediction of 4511. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2097).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -216.96|
|holiday         |    7.96|
|hum             | -850.89|
|mnth            |   82.52|
|season          |   16.92|
