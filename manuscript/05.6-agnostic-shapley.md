...
|:--------------------------------|----------:|
|Age                              |  0.0260000|
|First.sexual.intercourse         |  0.0680000|
|Hormonal.Contraceptives          | -0.0003333|
|Hormonal.Contraceptives..years.  |  0.0223333|
|IUD                              | -0.0036667|
|IUD..years.                      | -0.0010000|
|Num.of.pregnancies               |  0.0253333|
|Number.of.sexual.partners        |  0.0446667|
|STDs                             |  0.0526667|
|STDs..Number.of.diagnosis        |  0.0756667|
|STDs..Time.since.first.diagnosis |  0.0030000|
|STDs..Time.since.last.diagnosis  | -0.0013333|
|STDs..number.                    |  0.0646667|
|Smokes                           | -0.0036667|
|Smokes..years.                   |  0.0016667|
...
![Feature value contributions for instance 285. With a predicted 2464 rented bikes, this day is -2043 below the average prediction of 4507. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2043).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -394.25|
|holiday         |    0.33|
|hum             | -890.26|
|mnth            |    8.28|
|season          |    1.94|
