...
![Feature value contributions for woman 326 in the cervical cancer dataset. With a prediction of 0.40, this woman's cancer probability is 0.38 above the average prediction of 0.02. The feature value that increased the probability the most is the number of diagnosed STDs. The feature contributions sum up to the difference of actual and average prediction (0.38).](images/shapley-cervical-plot-1.png)

|feature                          |        phi|
|:--------------------------------|----------:|
|Age                              |  0.0706667|
|First.sexual.intercourse         |  0.0366667|
|Hormonal.Contraceptives          |  0.0040000|
|Hormonal.Contraceptives..years.  |  0.0300000|
|IUD                              |  0.0003333|
|IUD..years.                      | -0.0033333|
|Num.of.pregnancies               |  0.0246667|
|Number.of.sexual.partners        |  0.0360000|
|STDs                             |  0.0466667|
|STDs..Number.of.diagnosis        |  0.0963333|
|STDs..Time.since.first.diagnosis | -0.0003333|
|STDs..Time.since.last.diagnosis  |  0.0013333|
|STDs..number.                    |  0.0293333|
|Smokes                           |  0.0023333|
|Smokes..years.                   | -0.0026667|
...
![Feature value contributions for instance 285. With a predicted 2449 rented bikes, this day is -2052 below the average prediction of 4501. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-2052).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -702.62|
|holiday         |    1.64|
|hum             | -972.36|
|mnth            |   13.53|
|season          |   76.73|
