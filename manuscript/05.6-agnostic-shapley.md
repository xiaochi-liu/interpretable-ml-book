...
![Feature value contributions for woman 326 in the cervical cancer dataset. With a prediction of 0.60, this woman's cancer probability is 0.57 above the average prediction of 0.03. The feature value that increased the probability the most is the number of diagnosed STDs. The feature contributions sum up to the difference of actual and average prediction (0.57).](images/shapley-cervical-plot-1.png)

|feature                          |       phi|
|:--------------------------------|---------:|
|Age                              | 0.0296667|
|First.sexual.intercourse         | 0.0736667|
|Hormonal.Contraceptives          | 0.0040000|
|Hormonal.Contraceptives..years.  | 0.0693333|
|IUD                              | 0.0010000|
|IUD..years.                      | 0.0006667|
|Num.of.pregnancies               | 0.0430000|
|Number.of.sexual.partners        | 0.0680000|
|STDs                             | 0.1016667|
|STDs..Number.of.diagnosis        | 0.0950000|
|STDs..Time.since.first.diagnosis | 0.0070000|
|STDs..Time.since.last.diagnosis  | 0.0023333|
|STDs..number.                    | 0.0843333|
|Smokes                           | 0.0006667|
|Smokes..years.                   | 0.0000000|
...
![Feature value contributions for instance 285. With a predicted 2565 rented bikes, this day is -1943 below the average prediction of 4508. The feature values that had the most negative effects were the weather situation, humidity and the time trend (years since 2011). The temperature on that day had a positive effect compared to the average prediction. The feature contributions sum up to the difference of actual and average prediction (-1943).](images/shapley-bike-plot-1.png)


|feature         |     phi|
|:---------------|-------:|
|days_since_2011 | -552.35|
|holiday         |   -0.71|
|hum             | -763.66|
|mnth            |   20.02|
|season          |   28.00|
