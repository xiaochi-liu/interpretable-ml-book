...
<img src="images/lime-images-package-example-1.png" title="LIME expalanations for image classification. The example is taken from the lime R package." alt="LIME expalanations for image classification. The example is taken from the lime R package." width="500" />
