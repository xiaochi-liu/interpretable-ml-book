...
![The predicted price for a 50 m^2^ 2nd floor apartment with a nearby park and cat ban is 300,000€. Our goal is to explain how each of these features values contributed to the prediction.](images/shapley-instance.png)
...
![One sample repetition to estimate the contribution of `cat-banned` to the prediction.](images/shapley-instance-intervention.png)
...
![Shapley values for day 285. With a predicted 2329 rental bikes, this day is -2189 below the average prediction of 4517. The weather situation and humidity and were the largest negative contributions. The temperature on this day had a positive contribution. The sum of Shapley values yields the difference of actual and average prediction (-2189).](images/shapley-bike-plot-1.png)
